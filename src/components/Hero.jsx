				...
				<div className="flex flex-col items-start flex-1 md:flex md:flex-row md:gap-10 md:items-center lg:flex lg:flex-row lg:items-center lg:space-x-12 lg:justify-between">
					<div>
						<div className={`gradientText`}>
							<h1
							// className={` font-semibold text-[40px] leading-[36.9px] text-[#CFFAFF] md:leading-[4 5px] md:text-[35px] md:max-w-max lg:leading-[73.8px] lg:max-w-[580px] lg:text-[60px] `}
							>
						...
						<div
							...
							<p className={`max-w-[310px]`}>
								I specialize in building scalable, user focused products while
								delivering seamless web experiences for clients across Africa.
							</p>
					...
					<div className="mt-[2.5rem]">
						<div className="relative flex flex-col justify-center w-max">
							...
							<motion.div
								className={`shrink-0 w-[300px] h-[300px] lg:min-w-[400px] lg:min-h-[400px] border-[3px] border-[#1ED760]`}></motion.div>
						</div>
					</div>
